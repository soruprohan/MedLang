/* ast.h — MedLang AST node definitions + constructor declarations
...
typedef struct ASTNode {
    ...
    union {
        ...
        /* ----- statement list (singly-linked via tail) ----- */
        struct {
            struct ASTNode *head;
            struct ASTNode *tail;
        } list;

    }; /* anonymous union — access fields directly */
...
/* Statement list (right-linear linked list) */
